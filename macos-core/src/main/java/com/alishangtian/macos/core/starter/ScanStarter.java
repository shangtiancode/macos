package com.alishangtian.macos.core.starter;

import com.alishangtian.macos.core.config.ScannerConfig;
import com.alishangtian.macos.core.processor.CallBackProcessor;
import com.alishangtian.macos.core.processor.CheckCopyWorker;
import com.alishangtian.macos.core.processor.ScanListToCopyWorker;
import com.alishangtian.macos.core.processor.ScanZsetWorker;
    ...
    public void initThreadpool() {
        ...
        triggerExecutor = new ThreadPoolExecutor(scannerConfig.getTriggerThreadPoolCoreSize() < CORE_SIZE ? CORE_SIZE : scannerConfig.getTriggerThreadPoolCoreSize(), scannerConfig.getTriggerThreadPoolMaxSize() < MAX_SIZE ? MAX_SIZE : scannerConfig.getTriggerThreadPoolMaxSize(), THREAD_TIMEOUT_SECONDS, TimeUnit.SECONDS,
                ...
                new ThreadFactory() {
                    ...
                    @Override
                    public Thread newThread(Runnable r) {
                        return new Thread(r, "trigger-xtimer-pool-" + INDEX.getAndIncrement());
                    }
                });
    }
