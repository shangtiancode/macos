package com.alishangtian.macos.common.util;

/**
 * @Desc XtimerRequestUtils
 * @Time 2020/7/20 下午3:55
 * @Author maoxiaobing
 */
public class XtimerUtils {
    ...
    private static final String CONS_CLUSTER_XTIMER_BROKER_ADD_SUCCESS_COUNT_KEY = "broker:add:success:list:%s";
    private static final String CONS_CLUSTER_XTIMER_TRIGGERD_CLIENT_COUNT_KEY = "client:triggered:list:%s";
    private static final String CONS_CLUSTER_XTIMER_TRIGGERD_BROKER_COUNT_KEY = "broker:triggered:list:%s";
    private static final String CONS_CLUSTER_XTIMER_TRIGGERD_SUCCESS_BROKER_COUNT_KEY = "broker:triggered:success:list:%s";
    ...
    public static String constructBrokerAddSuccessCountKey(String clusterName) {
        return String.format(CONS_CLUSTER_XTIMER_BROKER_ADD_SUCCESS_COUNT_KEY, clusterName);
    }
    ...
    public static String constructClientTriggeredCountKey(String clusterName) {
        return String.format(CONS_CLUSTER_XTIMER_TRIGGERD_CLIENT_COUNT_KEY, clusterName);
    }
    ...
    public static String constructBrokerTriggeredCount(String clusterName) {
        return String.format(CONS_CLUSTER_XTIMER_TRIGGERD_BROKER_COUNT_KEY, clusterName);
    }
    ...
    public static String constructBrokerTriggeredSuccessCount(String clusterName) {
        return String.format(CONS_CLUSTER_XTIMER_TRIGGERD_SUCCESS_BROKER_COUNT_KEY, clusterName);
    }
